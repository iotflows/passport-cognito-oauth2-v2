...
function Strategy({clientDomain, clientID, clientSecret, callbackURL, passReqToCallback, region, state, store}, verify) {
  const options = {
...
Strategy.prototype.userProfile = function(AccessToken, done) {
  ...
  this.cognitoClient.getUser({AccessToken}, (err, userData) => {
    ...
    for (let i = userData.UserAttributes.length; i--;) {
